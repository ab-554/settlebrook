        ...
        <div className="container-page calc-container pt-8 pb-10 sm:pt-10 sm:pb-14 flex flex-col gap-5">
          ...
          {stateData.hasNonSubscriberSystem && (
            <p className="note note-caution" role="note">
              <strong>Texas Non-Subscriber Notice:</strong> Texas does not require private employers to carry workers comp. If your employer is a non-subscriber, you may have a personal injury claim instead. In this scenario, you can sue your employer for negligence in civil court for full damages (including pain and suffering). If this applies to you, use our <Link href="/pain-and-suffering-calculator/" className="text-link font-semibold">Pain &amp; Suffering Calculator</Link> instead.
            </p>
          )}

          {/* Illinois percentage of person info box */}
          {stateData.ppdMethod === 'percentage_of_person' && (
            <p className="note note-info" role="note">
        ...
        <div className="container-page pb-14 sm:pb-20">
          ...
          {stateData.slug === 'california' ? (
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Your permanent disability assessment begins with a comprehensive forensic medical evaluation. Either your primary treating doctor, a Qualified Medical Evaluator (QME) assigned by the state medical unit, or an Agreed Medical Evaluator (AME) jointly selected by both legal teams will examine your injuries. The evaluator measures your physical loss using the strict standards of the <strong style={{ color: 'var(--ink)' }}>American Medical Association (AMA) Guides to the Evaluation of Permanent Impairment, 5th Edition</strong>. This detailed medical report translates your physical damage into a raw Whole Person Impairment (WPI) score.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                The state of California does not pay settlements based on raw WPI percentages. Instead, your medical score is processed through the state&apos;s <strong style={{ color: 'var(--ink)' }}>Permanent Disability Rating Schedule (PDRS)</strong>. This statutory formula modifies your raw rating based on the exact anatomical body part injured, your age on the date of the accident, and your specific occupational classification. A 55-year-old roof framing contractor with a severe lumbar spine injury receives a substantially higher final disability rating than a 25-year-old accountant with the exact same spinal impairment, because manual heavy construction demands intense physical capacity. Each final percentage point of permanent disability corresponds to a fixed number of benefit weeks set by law, paying between $160 and $290 per week depending on the severity of your rating.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Navigating the California workers&apos; compensation claims process requires rigid adherence to statutory clocks. Missing a filing deadline will permanently forfeit your legal right to monetary benefits and medical care, regardless of how devastating your physical injuries might be. Under <strong style={{ color: 'var(--ink)' }}>California Labor Code Section 5400</strong>, you must formally notify your employer of your job-related injury within <strong style={{ color: 'var(--ink)' }}>30 days</strong> of the incident. Furthermore, you have exactly <strong style={{ color: 'var(--ink)' }}>one year</strong> from the date of your accident to officially submit a Workers&apos; Compensation Claim Form (DWC 1) to your employer to initiate the formal adjudication process.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                If the insurance company has been voluntarily paying your medical bills or issuing temporary wage checks without a formal court order, you generally have <strong style={{ color: 'var(--ink)' }}>five years</strong> from the original date of injury to formally resolve your claim or file an Application for Adjudication of Claim to request a trial before a WCAB judge. Additionally, California enforces powerful anti-retaliation protections under <strong style={{ color: 'var(--ink)' }}>Labor Code Section 132a</strong>. It is strictly illegal for your employer to terminate, demote, or harass you simply for exercising your legal right to file a workers&apos; compensation claim.
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                The state strictly limits what you can recover. Your TTD benefit rate is <strong style={{ color: 'var(--ink)' }}>70 percent</strong> of your Average Weekly Wage (AWW) for the first 26 weeks of your disability. If your lost wages extend beyond that six-month mark, your benefit shifts to 75 percent of your spendable income.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Let&apos;s put concrete math to this statute. Suppose you are an electrician earning $1,400 a week. For the first 26 weeks of your recovery, the insurance company will pay you 70 percent of that wage, which equals <strong style={{ color: 'var(--amber)' }}>$980 per week</strong>. You must also factor in the state-mandated caps. For the current period ({stateData.weeklyCapEffectivePeriod}), the maximum weekly benefit is <strong style={{ color: 'var(--amber)' }}>${stateData.weeklyCapAmount.toLocaleString()}</strong>. Because your $980 calculation falls below the maximum cap, you receive your full calculated rate. If you were earning $2,000 a week, your 70 percent calculation would be $1,400, but the insurance company would legally cap your checks at exactly ${stateData.weeklyCapAmount.toLocaleString()} per week.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                <strong style={{ color: 'var(--ink)' }}>Your pre-injury wages</strong> form the baseline for everything. A worker earning $20 an hour will simply mathematically receive a smaller settlement than a worker earning $40 an hour, because all state benefits are calculated as a percentage of your Average Weekly Wage.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                <strong style={{ color: 'var(--ink)' }}>Your impairment rating</strong> is the primary battleground in a subscriber case. The insurance company will frequently send you to their own doctors, who have a notorious habit of assigning artificially low impairment ratings. A single percentage point drop costs you exactly three weeks of income. Fighting a low rating by requesting a Designated Doctor exam is often the most lucrative move you can make.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                If you need legal help, the state heavily regulates <strong style={{ color: 'var(--ink)' }}>Texas workers&apos; comp attorney fees</strong>. By law, an attorney handling a subscriber claim cannot charge you by the hour or take a massive chunk of your medical benefits. They are limited to a maximum of 25 percent of your income benefits recovered, and the DWC must approve their fees. This ensures that you can afford top-tier representation without going out of pocket.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Time is the ultimate enemy of an injured worker. The Texas workers&apos; comp statute of limitations is completely unforgiving. You must report your injury to your employer within <strong style={{ color: 'var(--ink)' }}>30 days</strong> of the accident.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                More critically, you have exactly <strong style={{ color: 'var(--ink)' }}>one year</strong> from the date of injury to officially file your claim with the Texas Division of Workers Compensation. This is accomplished by filing DWC Form-041. Do not rely on your employer or the old TWCC Texas legacy systems to do this for you. If your HR department promises they filed the paperwork but fails to submit the official DWC form within that one-year window, your claim will be permanently barred. You will lose all rights to medical care and wage replacement, no matter how catastrophic your injuries are.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Because of the dual system, outcomes look structurally different depending on your employer&apos;s insurance status. For <strong style={{ color: 'var(--ink)' }}>subscribers</strong>, the system runs on the statutory formula above — a rigid math equation rather than a windfall. For <strong style={{ color: 'var(--ink)' }}>non-subscribers</strong>, your claim is a personal injury lawsuit instead, where a civil jury can award pain and suffering damages the workers&apos; comp formula never includes.
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                The statutory math for these impairment benefits is precise. You are entitled to <strong style={{ color: 'var(--ink)' }}>two weeks of benefits for every single percentage point</strong> of your assigned impairment rating. Furthermore, these specific checks are paid at <strong style={{ color: 'var(--ink)' }}>75 percent of your average weekly wage</strong>. Imagine you are a nurse in Orlando earning an average weekly wage of $1,000. You suffer a severe spinal injury lifting a patient. At MMI, your doctor assigns you a 15 percent impairment rating. Because you receive two weeks of pay per percentage point, you are entitled to 30 weeks of impairment checks. Since your average weekly wage was $1,000, your impairment benefit rate is <strong style={{ color: 'var(--amber)' }}>$750 per week</strong>. Over those 30 weeks, you will receive a total of <strong style={{ color: 'var(--amber)' }}>$22,500</strong> in impairment income benefits.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                It is absolutely crucial to understand that the workers&apos; comp system does not care about your emotional trauma. Workers&apos; comp explicitly does <strong style={{ color: 'var(--ink)' }}>not</strong> cover pain and suffering. If you lose a finger in a machine press, you are compensated for the anatomical loss and the medical bills, but you receive zero dollars for the sheer agony of the experience.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                By law, an attorney can charge <strong style={{ color: 'var(--ink)' }}>20 percent of the first $5,000</strong> in benefits secured, <strong style={{ color: 'var(--ink)' }}>15 percent of the next $5,000</strong>, and <strong style={{ color: 'var(--ink)' }}>10 percent of any remaining settlement amount</strong>. If your lawyer aggressively negotiates a $100,000 settlement on your behalf, their fee is mathematically limited to <strong style={{ color: 'var(--amber)' }}>$10,750</strong>. You walk away with the vast majority of the funds. Because lawyers operate on this contingency fee basis, they are financially motivated to maximize your exact settlement amount.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                In the realm of personal injury law, missing a deadline is fatal to your case. The Florida workers&apos; comp statute of limitations dictates that you have exactly <strong style={{ color: 'var(--ink)' }}>two years</strong> from the specific date of your workplace accident to file a formal Petition for Benefits.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Picture this: you are working a high-speed packing line at a distribution warehouse in Queens when a jammed conveyor catches your right arm. You spend the afternoon at Elmhurst Hospital with a severe radius fracture and a torn wrist tendon. Over the next six months, your orthopedic surgeon bills <strong style={{ color: 'var(--amber)' }}>$28,400</strong> for structural realignment and physical therapy, and you lose <strong style={{ color: 'var(--amber)' }}>$19,200</strong> in wages while totally unable to lift packages.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                While you are actively recovering and your doctor declares you completely unable to work, you receive Temporary Total Disability (TTD) benefits. The New York statutory formula for TTD is straightforward: you receive <strong style={{ color: 'var(--ink)' }}>66.67% (two-thirds)</strong> of your Average Weekly Wage (AWW), subject to a strict statutory ceiling.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Your AWW is calculated by taking your total gross earnings from the 52 weeks immediately preceding your accident and dividing that number by 52. Once the WCB determines your baseline wage, they apply the state cap. For {stateData.weeklyCapEffectivePeriod}, the New York maximum weekly benefit sits at <strong style={{ color: 'var(--amber)' }}>${stateData.weeklyCapAmount.toLocaleString()} per week</strong>. This figure updates annually every July 1st based on the statewide average weekly wage, and it represents one of the highest benefit ceilings in the entire country.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Notice the financial reality facing Worker B. Even though the electrician earned $2,400 a week before the crash, New York law slashes their wage replacement by more than half. Over a six-month recovery period, Worker B loses <strong style={{ color: 'var(--amber)' }}>$11,832</strong> in uncompensated income due to the statutory cap.
              </p>
              ...
              <ul style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px', paddingLeft: '24px' }}>
                <li style={{ marginBottom: '6px' }}>Arm: <strong style={{ color: 'var(--ink)' }}>312 weeks</strong></li>
                <li style={{ marginBottom: '6px' }}>Leg: <strong style={{ color: 'var(--ink)' }}>288 weeks</strong></li>
                <li style={{ marginBottom: '6px' }}>Hand: <strong style={{ color: 'var(--ink)' }}>244 weeks</strong></li>
                <li style={{ marginBottom: '6px' }}>Foot: <strong style={{ color: 'var(--ink)' }}>205 weeks</strong></li>
                <li style={{ marginBottom: '6px' }}>Eye: <strong style={{ color: 'var(--ink)' }}>160 weeks</strong></li>
                <li style={{ marginBottom: '6px' }}>Thumb: <strong style={{ color: 'var(--ink)' }}>75 weeks</strong></li>
              </ul>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <ul style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px', paddingLeft: '24px' }}>
                <li style={{ marginBottom: '8px' }}>Find the statutory base: A full arm equals <strong style={{ color: 'var(--ink)' }}>312 weeks</strong>.</li>
                <li style={{ marginBottom: '8px' }}>Multiply by the impairment rating: 312 weeks &times; 20% = <strong style={{ color: 'var(--amber)' }}>62.4 weeks</strong> of compensation.</li>
                <li style={{ marginBottom: '8px' }}>Multiply by the worker&apos;s compensation rate: If your TTD rate was $800 a week, your gross SLU award is 62.4 &times; $800 = <strong style={{ color: 'var(--amber)' }}>$49,920</strong>.</li>
              </ul>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                However, the insurance company does not simply hand you a check for $49,920. Under New York law, the insurer gets to take a dollar-for-dollar credit for all the TTD wage replacement checks they already paid you while you were out of work. If you collected $19,200 in temporary disability checks over six months, that amount is deducted from your award. Your final, net lump-sum SLU check equals <strong style={{ color: 'var(--amber)' }}>$30,720</strong>.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Because living on weekly checks for years keeps your medical files open and exposes the insurance company to endless administrative costs, both sides usually prefer to part ways. This is accomplished through a New York <strong style={{ color: 'var(--ink)' }}>Section 32 settlement</strong>.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Under Section 6(d) of the Act, you must formally file your Application for Adjustment of Claim (Form IC8) with the IWCC within <strong style={{ color: 'var(--ink)' }}>three years</strong> from the exact date of your workplace accident, or within <strong style={{ color: 'var(--ink)' }}>two years</strong> from the date you received your last temporary compensation or medical payment — whichever date is later. Simply reporting the injury to your human resources department or receiving casual informal checks from your employer does not stop this legal clock. If you fail to file your formal application with the state commission before the deadline passes, your right to secure a settlement or demand future medical care is permanently extinguished.
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                When a workplace injury completely takes you off the schedule, you are entitled to Temporary Total Disability benefits. Under state law, your weekly check is standardly calculated at 66.67 percent of your pre-injury Average Weekly Wage. Lower-wage earners might receive a higher percentage, up to 90 percent, to ensure they can still afford basic survival. However, the state imposes a strict statutory ceiling on these payments, adjusted annually based on the statewide average weekly wage. While the maximum weekly benefit was <strong style={{ color: 'var(--amber)' }}>$1,325 in 2024</strong>, the ceiling for injuries occurring in 2026 is currently set at <strong style={{ color: 'var(--amber)' }}>$1,394 per week</strong>, subject to annual adjustment by the state.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Consider a real-world scenario. You work as a union electrician earning <strong style={{ color: 'var(--amber)' }}>$1,800 per week</strong>. A scaffolding collapse shatters your femur, leaving you bedridden. Two-thirds of your $1,800 wage equals <strong style={{ color: 'var(--amber)' }}>$1,200</strong>. Because your calculated rate falls below the 2026 statutory cap of $1,394, your tax-free weekly workers comp check will be exactly $1,200. The distinct advantage of Pennsylvania law is that there is no arbitrary time limit on total disability. If your injury is so catastrophic that you can never perform any kind of work again, you can theoretically collect that $1,200 every week for the rest of your life.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Imagine you are a machinist earning an average weekly wage that translates to an <strong style={{ color: 'var(--amber)' }}>$800 weekly compensation rate</strong>. A press malfunction crushes your index finger, requiring surgical amputation. The state schedule dictates that the loss of an index finger commands 50 weeks of compensation. You are legally owed an automatic <strong style={{ color: 'var(--amber)' }}>$40,000</strong> specific loss payment, plus an additional state-mandated healing period payout. The insurance company will inevitably try to dispute the extent of a &apos;loss of use&apos; claim by demanding a Pennsylvania IME, or Independent Medical Examination. They hire doctors trained to argue that you still have partial functionality, requiring an aggressive legal defense to secure your full scheduled payout.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Securing maximum value in a C&amp;R requires brutal financial calculus. If you are currently drawing <strong style={{ color: 'var(--amber)' }}>$1,000 per week</strong> and you were recently downgraded to partial disability with 400 weeks remaining on your cap, your maximum future wage exposure is <strong style={{ color: 'var(--amber)' }}>$400,000</strong>. No insurance company will simply hand you a check for $400,000 today because money depreciates over time. They will reduce the offer to its present value, often countering with <strong style={{ color: 'var(--amber)' }}>$280,000</strong>. To bridge that gap, an aggressive negotiator will calculate the astronomical costs of your future medical care — decades of prescription pain medication, joint replacements, and physical therapy — using that leverage to force the lump sum substantially higher.
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Before you even think about negotiating a final settlement, you must survive the immediate financial crisis of being unable to clock in. Temporary Total Disability, or TTD, is the lifeline that keeps your household afloat. Under Ohio law, the calculation actually changes depending on how long you are forced out of work. For the first twelve weeks of your disability, you receive <strong style={{ color: 'var(--ink)' }}>seventy-two percent</strong> of your full weekly wage. Starting on week thirteen, your compensation shifts downward to the standard TTD rate, which equals <strong style={{ color: 'var(--ink)' }}>66.67% of your average weekly wage</strong>.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Let&apos;s look at the concrete math. If you averaged <strong style={{ color: 'var(--amber)' }}>$1,200 a week</strong> before a forklift crushed your foot, your standard TTD checks will be roughly <strong style={{ color: 'var(--amber)' }}>$800 a week</strong>. The state does, however, impose a strict statutory ceiling. For injuries occurring in 2026, the maximum weekly TTD rate is capped at <strong style={{ color: 'var(--amber)' }}>$1,281</strong>, though this figure is subject to annual adjustment by the state based on statewide economic metrics. The state fund pays this wage replacement only until a designated doctor declares that you have reached maximum medical improvement, meaning your condition has stabilized and will not significantly improve with further active treatment — there is no fixed week limit on TTD itself, though R.C. 4123.56(A) requires a medical examination after 200 weeks of continuous total disability to check whether you have reached that point.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Unlike some states that simply assign a flat dollar value to a specific medical diagnosis, an Ohio permanent partial disability is calculated based on a percentage of impairment to your whole person. A state-sanctioned doctor will physically examine you and assign an impairment rating. If the doctor determines your crushed foot results in a <strong style={{ color: 'var(--ink)' }}>ten percent whole person impairment</strong>, state statutes dictate exactly how many weeks of pay that percentage represents. You receive two weeks of compensation for every one percent of impairment. Therefore, a ten percent rating equals twenty weeks of pay at a statutorily capped weekly rate.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Ohio also maintains a parallel system of scheduled awards for catastrophic injuries involving amputations or total loss of use. If you lose an arm, a leg, or an eye, the statute bypasses the percentage system and assigns a strict, predetermined number of weeks of compensation. For example, the total amputation or loss of use of a hand guarantees <strong style={{ color: 'var(--ink)' }}>one hundred and seventy-five weeks</strong> of pay at the maximum weekly rate, regardless of your actual historical wage history.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                State administrators love lump sum settlements because it permanently caps their financial exposure to your medical future. You must approach an Ohio lump sum settlement with extreme caution. If your settlement check is <strong style={{ color: 'var(--amber)' }}>$40,000</strong>, but your physician determines you require a <strong style={{ color: 'var(--amber)' }}>$60,000</strong> spinal fusion surgery three years from now, you will be paying for that operation entirely out of your own pocket. The state will not reopen a fully settled claim simply because your condition worsened.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Time is your absolute worst enemy after a workplace injury. The Ohio workers comp statute of limitations is ruthlessly strict. You have exactly <strong style={{ color: 'var(--ink)' }}>two years</strong> from the date of your injury to officially file your claim. This is accomplished by submitting the First Report of Injury, commonly referred to as the Ohio FROI. If you simply notify your shift supervisor but fail to ensure the Ohio FROI is actually filed with the state within that two-year window, your claim will be permanently barred. You will lose all rights to medical coverage, wage replacement, and settlement negotiations, no matter how severe your injuries are or how obviously the accident occurred at work.
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                When the doctor writes you completely out of work to heal, you are entitled to Temporary Total Disability benefits, known as TTD. Under North Carolina law, your TTD rate is strictly set at <strong style={{ color: 'var(--ink)' }}>66.67 percent</strong> of your Average Weekly Wage. To find your Average Weekly Wage, the insurance company will look at your gross earnings over the 52 weeks immediately preceding your injury, including overtime and bonuses, and divide that total by 52.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                To visualize a clincher calculation, let us look at our equipment operator with the <strong style={{ color: 'var(--amber)' }}>$36,000</strong> impairment rating on his back. If his doctor estimates he will need <strong style={{ color: 'var(--amber)' }}>$15,000</strong> in medication and physical therapy over the next ten years, and perhaps another <strong style={{ color: 'var(--amber)' }}>$30,000</strong> for a potential hardware removal surgery, his attorney might negotiate a final clincher agreement of <strong style={{ color: 'var(--amber)' }}>$81,000</strong>. This single check pays for the permanent damage and transfers the burden of funding his future medical needs directly to him.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                If you are negotiating a six-figure clincher agreement involving future surgical risks, handling the adjuster alone is incredibly dangerous. Hiring a legal professional levels the playing field, but you need to understand how the money works. A North Carolina workers comp attorney operates on a strict contingency fee basis, meaning they only get paid if they secure a settlement or a beneficial ruling for you. State law strictly caps these attorney fees at a maximum of <strong style={{ color: 'var(--ink)' }}>25 percent</strong> of your recovery. Furthermore, the NC IC must independently review and approve all attorney fees to ensure they are fair and legally compliant. If your attorney negotiates an <strong style={{ color: 'var(--amber)' }}>$80,000</strong> clincher agreement, the maximum fee they can collect is <strong style={{ color: 'var(--amber)' }}>$20,000</strong>, leaving you with a net recovery of <strong style={{ color: 'var(--amber)' }}>$60,000</strong>. You never pay hourly rates out of your own pocket.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                While you are actively recovering and your doctor says you cannot work at all, you are entitled to Temporary Total Disability benefits. Arizona law mandates that your temporary disability rate is exactly <strong style={{ color: 'var(--ink)' }}>66.67%</strong> of your established average monthly wage. If you are married or have dependents, the state adds a nominal extra <strong style={{ color: 'var(--amber)' }}>$25</strong> per month to your check.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Let us look at the concrete dollar math. If you earned <strong style={{ color: 'var(--amber)' }}>$3,000</strong> a month before your accident, your temporary disability checks will total roughly <strong style={{ color: 'var(--amber)' }}>$2,000</strong> a month, paid out bi-weekly. But what happens if you are a high earner? Arizona actually utilizes a very high maximum average monthly wage limit, which is subject to annual adjustment by the ICA based on inflation and economic indexes.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                For workplace injuries occurring in 2026, the ICA capped the maximum average monthly wage at <strong style={{ color: 'var(--amber)' }}>$6,131.00</strong>. This means that even if you earn <strong style={{ color: 'var(--amber)' }}>$12,000</strong> a month as an executive or a specialized union contractor, the state system calculates your 66.67% rate using that $6,131.00 ceiling. Therefore, your absolute maximum monthly temporary benefit tops out at approximately <strong style={{ color: 'var(--amber)' }}>$4,087</strong>. If your doctor clears you to return to work on light duty but you are earning less than your pre-injury wage, you shift to Temporary Partial Disability, where the insurance company pays 66.67% of the difference between your old wage and your new light-duty pay. Under A.R.S. § 23-1045, Arizona sets no fixed week limit on temporary disability — these checks continue until your treating physician declares you &quot;medically stationary,&quot; Arizona&apos;s term for maximum medical improvement.
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Once you complete your surgeries and physical therapy, your primary treating physician will place you at Maximum Medical Improvement. If you do not make a 100% full recovery, your doctor will assign you an Arizona workers comp impairment rating. This is where you encounter the most critical legal concept in Arizona permanent disability workers comp: the strict dividing line between <strong style={{ color: 'var(--ink)' }}>scheduled</strong> and <strong style={{ color: 'var(--ink)' }}>unscheduled injuries</strong>. Your financial future depends entirely on which side of this line your injury falls.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                If you injure a specific extremity — like your arm, hand, leg, foot, or your vision or hearing — Arizona treats this as a scheduled injury. The state legislature has pre-assigned a rigid maximum number of months of compensation for each of these body parts under the law. For example, a total loss of use of a major dominant arm entitles you to <strong style={{ color: 'var(--ink)' }}>60 months</strong> of compensation. A minor hand entitles you to <strong style={{ color: 'var(--ink)' }}>40 months</strong>. If your doctor gives you a 10% impairment rating on your dominant arm, you receive 10% of those 60 months, which equals six months of Arizona PPD checks. These scheduled permanent partial disability payments are typically paid out at <strong style={{ color: 'var(--ink)' }}>55%</strong> of your average monthly wage.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Conversely, if you injure your spine, neck, head, hips, or if you injure multiple scheduled body parts in the same accident, you have what is called an <strong style={{ color: 'var(--ink)' }}>unscheduled injury</strong>. Unscheduled injuries are not paid based on a rigid chart of body parts. Instead, they are compensated based on your <strong style={{ color: 'var(--ink)' }}>Loss of Earning Capacity</strong>. The Industrial Commission will look at your physical restrictions and determine how much less money you are capable of earning in the open labor market compared to before your accident.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Proving this loss requires aggressive legal work, often involving functional capacity evaluations and vocational experts. If your pre-injury average monthly wage was <strong style={{ color: 'var(--amber)' }}>$4,000</strong>, but your permanent lumbar fusion restricts you to a desk job paying only <strong style={{ color: 'var(--amber)' }}>$2,500</strong> a month, your loss of earning capacity is <strong style={{ color: 'var(--amber)' }}>$1,500</strong>. You will generally receive 55% of that $1,500 difference every single month. Because unscheduled benefits can theoretically be awarded for the rest of your life, these cases almost always result in the largest Arizona workers comp settlement payouts.
              </p>
            ...
            <article className="editorial">
              ...
              <ul style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px', paddingLeft: '20px', listStyleType: 'disc' }}>
                <li style={{ marginBottom: '8px' }}><strong style={{ color: 'var(--ink)' }}>Multiple body parts in one case.</strong> If your claim petition covers more than one disability, each one is rated and assigned its own number of weeks separately — they aren&apos;t added together before the weeks-to-dollars bracket is applied.</li>
                <li><strong style={{ color: 'var(--ink)' }}>Amputation.</strong> When the injury involves an actual amputation (as opposed to loss of use without amputation), New Jersey adds an extra 30% on top of the scheduled award, and that extra 30% isn&apos;t counted when figuring an attorney&apos;s fee.</li>
              </ul>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                <strong style={{ color: 'var(--ink)' }}>Notice to your employer:</strong> tell your employer as soon as you can. The statute sets up a layered rule: if your employer doesn&apos;t already know about the injury, you generally need to give notice within 14 days to avoid a delay in when benefits start, and notice given within 30 days generally cures small defects unless your employer can show it was actually harmed by the delay. As an outer limit, if your employer has no actual knowledge and gets no notice within 90 days of the injury, no compensation is allowed at all. Source: R.S. 34:15-17.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Workers&apos; compensation claims in Virginia are handled by the <strong style={{ color: 'var(--ink)' }}>Virginia Workers&apos; Compensation Commission (VWC)</strong>, a state agency separate from the courts. The program is set out in <strong style={{ color: 'var(--ink)' }}>Title 65.2 of the Code of Virginia</strong>.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <ul style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px', paddingLeft: '20px', listStyleType: 'disc' }}>
                <li style={{ marginBottom: '8px' }}><strong style={{ color: 'var(--ink)' }}>Notice to employer:</strong> report the injury to your employer within <strong style={{ color: 'var(--ink)' }}>30 days</strong> of the accident, or within <strong style={{ color: 'var(--ink)' }}>60 days</strong> of being told an illness is an occupational disease.</li>
                <li><strong style={{ color: 'var(--ink)' }}>Claim filing deadline:</strong> file your formal claim with the Commission within <strong style={{ color: 'var(--ink)' }}>2 years of the date of accident</strong>. For most occupational diseases, the deadline is 2 years from when you&apos;re told the disease is work-related, and no more than 5 years from your last workplace exposure.</li>
              </ul>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Say an injured worker in Virginia has an average weekly wage of <strong style={{ color: 'var(--ink)' }}>$1,200</strong> before the injury.
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                <strong style={{ color: 'var(--ink)' }}>Rate.</strong> Temporary total disability (TTD) is paid at 66 2/3% of the worker&apos;s average weekly wage (AWW) at the time of injury, subject to the statewide maximum and minimum. Source: Minn. Stat. §176.101, subd. 1.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '10px' }}>
                <strong style={{ color: 'var(--ink)' }}>Table A — injuries on or after October 1, 2023 and before October 1, 2026</strong> (first four bands of twenty):
              </p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '10px' }}>
                <strong style={{ color: 'var(--ink)' }}>Table B — injuries on or after October 1, 2026</strong> (same first four bands, enacted by 2026 Minn. Laws ch. 103, §10):
              </p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Under either track, PPD is paid <strong style={{ color: 'var(--ink)' }}>after</strong> temporary disability ends, starting on the date of MMI.
              </p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>
                Say your average weekly wage before the injury was <strong style={{ color: 'var(--ink)' }}>$1,200</strong>, and you hurt your hand at work.
              </p>
