        ...
        <div className="container-page py-10 sm:py-14">
          ...
          <article className="editorial">
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              ...
              <li><strong style={{ color: 'var(--ink)' }}>Florida</strong>: 66 2/3% of AWW, subject to the statutory min/max (<a href="https://www.myfloridacfo.com/division/wc/insurer/maximum-compensation-rate-table" target="_blank" rel="noopener noreferrer" style={linkStyle}>Florida CFO, Maximum Compensation Rate Table</a>).</li>
              <li><strong style={{ color: 'var(--ink)' }}>Pennsylvania</strong>: 66 2/3% of AWW, subject to the statewide average weekly wage maximum (<a href="https://www.pa.gov/agencies/dli/programs-services/workers-compensation/workers--compensation-claim/statewide-average-weekly-wage-saww" target="_blank" rel="noopener noreferrer" style={linkStyle}>Pennsylvania Dept. of Labor &amp; Industry, SAWW page</a>).</li>
            </ul>
            <p style={bodyStyle}>Not every state uses two-thirds, though. <strong style={{ color: 'var(--ink)' }}>Michigan</strong> pays 80% of your <em>after-tax</em> (spendable) AWW rather than 66 2/3% of gross AWW (<a href="https://www.michigan.gov/leo/-/media/Project/Websites/leo/Documents/WDCA-Calculation-Program/wca_2026_Rate_Book.pdf" target="_blank" rel="noopener noreferrer" style={linkStyle}>Michigan LEO, 2026 Weekly Benefit Tables</a>). Other states use their own percentages too, so check your state&rsquo;s formula rather than assuming two-thirds applies everywhere.</p>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              ...
              <li><strong style={{ color: 'var(--ink)' }}>New York</strong> sets its maximum at two-thirds of the New York State Average Weekly Wage (NYSAWW); the rate effective July 1, 2026 through June 30, 2027 is based on the 2025 NYSAWW of $1,922.25 (<a href="https://www.wcb.ny.gov/content/main/SubjectNos/sn046_1805.jsp" target="_blank" rel="noopener noreferrer" style={linkStyle}>NY Workers&rsquo; Compensation Board, Subject Number bulletin</a>).</li>
            </ul>
              ...
              <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid var(--line)' }}>
                    <th className="text-left py-2 pr-4" style={{ color: 'var(--ink)' }}>State</th>
                    <th className="text-left py-2 pr-4" style={{ color: 'var(--ink)' }}>2026 Maximum Weekly Benefit</th>
                    <th className="text-left py-2 pr-4" style={{ color: 'var(--ink)' }}>Effective Period</th>
                    <th className="text-left py-2" style={{ color: 'var(--ink)' }}>Source</th>
                  </tr>
                </thead>
                <tbody>
                  {stateMaxTable.map((row) => (
                    <tr key={row.name} style={{ borderBottom: '1px solid var(--line)' }}>
                      <td className="py-2 pr-4" style={{ color: 'var(--ink-2)' }}><Link href={row.href} style={linkStyle}>{row.name}</Link></td>
                      <td className="py-2 pr-4" style={{ color: 'var(--ink-2)' }}>{row.max}</td>
                      <td className="py-2 pr-4" style={{ color: 'var(--ink-2)' }}>{row.period}</td>
                      <td className="py-2" style={{ color: 'var(--ink-2)' }}><a href={row.sourceUrl} target="_blank" rel="noopener noreferrer" style={linkStyle}>{row.sourceLabel}</a></td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              ...
              <li><strong style={{ color: 'var(--ink)' }}>Illinois</strong> has no fixed week cap. Under 820 ILCS 305/8(b), &ldquo;the employer pays TTD benefits to an injured employee until the employee has returned to work or has reached maximum medical improvement (MMI),&rdquo; whichever comes first, according to the Illinois Workers&rsquo; Compensation Commission&rsquo;s own handbook (<a href="https://iwcc.illinois.gov/content/dam/soi/en/web/iwcc/documents/handbook/IWCC%20handbook%2006.06.24.pdf" target="_blank" rel="noopener noreferrer" style={linkStyle}>IWCC handbook</a>).</li>
            </ul>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              ...
              <li>$1,500 × 2/3 = <strong style={{ color: 'var(--amber)' }}>$1,000.00/week</strong></li>
