      ...
      <main className="min-h-screen" style={{ backgroundColor: '#050A18' }}>
        ...
        <article className="max-w-7xl mx-auto px-6 sm:px-8 py-12">
          <div className="max-w-3xl">
            ...
            <h2 className="heading-gradient" style={h2Style}>What Is a Diminished Value Claim?</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>Third-Party Claims vs. First-Party Claims</h2>
            ...
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Diminished value = 10% of the vehicle&rsquo;s pre-accident retail value × a damage modifier × a mileage modifier</strong></p>
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
            ...
            <h2 className="heading-gradient" style={h2Style}>A Hypothetical Example of the 17c Method</h2>
            ...
            <ol style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'decimal' }}>
              <li><strong style={{ color: '#E2E8F0' }}>Base loss:</strong> 10% of $20,000 = $2,000</li>
              <li><strong style={{ color: '#E2E8F0' }}>Damage modifier:</strong> the vehicle had moderate structural damage, so a modifier of 0.5 is applied. $2,000 × 0.5 = $1,000</li>
              <li><strong style={{ color: '#E2E8F0' }}>Mileage modifier:</strong> the car had moderate mileage for its age, so a modifier of 0.8 is applied. $1,000 × 0.8 = $800</li>
            </ol>
            <p style={bodyStyle}><strong style={{ color: '#FBBF24' }}>Result: an estimated diminished value of $800.</strong></p>
            ...
            <h2 className="heading-gradient" style={h2Style}>Why the 17c Formula Draws Criticism</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>Independent Appraisals: How They Differ</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>Which States Recognize First-Party Diminished Value Claims</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>How Diminished Value Fits Into Your Car Accident Settlement</h2>
            ...
            <p style={bodyStyle}>Property damage, including a diminished value figure if you&rsquo;re pursuing one, is <strong style={{ color: '#E2E8F0' }}>not</strong> run through that multiplier. It&rsquo;s added on top, dollar-for-dollar, as part of your special damages total. Here&rsquo;s what that looks like with round numbers:</p>
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              ...
              <li><strong style={{ color: '#FBBF24' }}>Total settlement estimate: $12,000 + $25,000 = $37,000</strong></li>
            </ul>
            ...
            <h3 className="heading-gradient" style={h3Style}>Is a diminished value claim the same thing as a property damage claim?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Do I need to hire an appraiser to file a diminished value claim?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Can I get diminished value from my own insurance company?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Does the 17c formula apply everywhere?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Will a diminished value payout be added to my pain and suffering, or counted separately?</h3>
