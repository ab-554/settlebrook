      ...
      <main className="min-h-screen" style={{ backgroundColor: '#050A18' }}>
        ...
        <article className="max-w-7xl mx-auto px-6 sm:px-8 py-12">
          <div className="max-w-3xl">
            ...
            <h2 className="heading-gradient" style={h2Style}>No Injury: What a Property-Damage-Only Claim Covers</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li><strong style={{ color: '#E2E8F0' }}>Repair costs</strong> — what a body shop charges to return the car to its pre-accident condition, usually based on an insurance appraisal or shop estimate.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Rental or loss-of-use costs</strong> — reimbursement for a rental car (or the cash value of not having your vehicle) while it&rsquo;s in the shop, or while a total-loss payout is being worked out.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Diminished value</strong> — the drop in resale value a vehicle carries simply because it now has an accident on its title history, even after a proper repair. Insurers and courts have argued over how to calculate this for more than two decades. If your car was repaired but you think it&rsquo;s worth less because of the accident, our <Link href="/blog/diminished-value-claim/" style={linkStyle}>diminished value claim guide</Link> walks through how that number is typically calculated and who owes it.</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>Soft-Tissue Injuries: What Actually Changes the Value</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li><strong style={{ color: '#E2E8F0' }}>How quickly you were evaluated.</strong> A doctor, urgent care, or ER visit the same day or within a day or two of the crash ties your symptoms to the accident. A long gap gives an insurer room to argue something else caused the pain.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Whether treatment was consistent.</strong> Following through on the recommended treatment plan, without long unexplained gaps, supports the claim that the injury was real and required ongoing care.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Whether the record is complete.</strong> Diagnosis codes, physical therapy notes, and a clear point where you were declared recovered give a concrete basis for valuing the claim rather than leaving it to guesswork.</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>No-Fault States: PIP Pays First, and a Threshold Limits Pain-and-Suffering Claims</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>At-Fault States: Filing Against the Other Driver&rsquo;s Insurance</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li><strong style={{ color: '#E2E8F0' }}>California</strong> allows an individual to sue for up to $12,500 in small claims court (businesses are limited to $6,250) (<a href="https://selfhelp.courts.ca.gov/small-claims-california" target="_blank" rel="noopener noreferrer" style={linkStyle}>California Courts Self-Help Guide</a>).</li>
              <li><strong style={{ color: '#E2E8F0' }}>Texas</strong> allows small claims cases in justice court up to $20,000 (<a href="https://guides.sll.texas.gov/small-claims" target="_blank" rel="noopener noreferrer" style={linkStyle}>Texas State Law Library</a>).</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>How Long You Have to File</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li><strong style={{ color: '#E2E8F0' }}>Texas</strong> requires that a suit for personal injury be brought &ldquo;not later than two years after the day the cause of action accrues&rdquo; (<a href="https://www.txcourts.gov/media/1456324/210513.pdf" target="_blank" rel="noopener noreferrer" style={linkStyle}>Tex. Civ. Prac. &amp; Rem. Code § 16.003(a)</a>, as cited by the Texas Supreme Court).</li>
              <li><strong style={{ color: '#E2E8F0' }}>California</strong> sets a two-year deadline for &ldquo;[i]njury to a person,&rdquo; measured from the date of the injury (<a href="https://selfhelp.courts.ca.gov/civil-lawsuit/statute-limitations" target="_blank" rel="noopener noreferrer" style={linkStyle}>Cal. Code Civ. Proc. § 335.1</a>, as summarized by the California Courts Self-Help Guide).</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>Worked Example: A Minor Soft-Tissue Claim</h2>
            ...
            <pre style={{ ...bodyStyle, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(99,179,237,0.15)', borderRadius: 12, padding: 16, overflowX: 'auto', fontSize: '13px' }}>
...
fault-adjusted    = total × (100 − fault%) / 100`}
            ...
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Hypothetical facts:</strong> A rear-end collision leaves the driver with a diagnosed minor whiplash strain (multiplier: 1.5). Medical bills come to $3,200, with no future medical care anticipated. Lost wages are $800 (8 missed workdays at a $100 daily wage), with no future lost wages. Vehicle repair (property damage) costs $2,400. The other driver is 100% at fault (0% fault on our hypothetical claimant).</p>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Multiplier method:</strong></p>
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li>multiplierBase = $3,200 + $0 + $800 + $0 = <strong style={{ color: '#FBBF24' }}>$4,000</strong></li>
              <li>specialDamages = $4,000 + $2,400 = <strong style={{ color: '#FBBF24' }}>$6,400</strong></li>
              <li>pain &amp; suffering = $4,000 × 1.5 = <strong style={{ color: '#FBBF24' }}>$6,000</strong></li>
              <li>total = $6,400 + $6,000 = <strong style={{ color: '#FBBF24' }}>$12,400</strong></li>
              <li>fault-adjusted = $12,400 × (100 − 0) / 100 = <strong style={{ color: '#FBBF24' }}>$12,400</strong></li>
            </ul>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Per diem method (alternative way to value pain and suffering):</strong> Instead of a multiplier, the per diem method assigns a daily dollar value to pain and suffering — often the person&rsquo;s own daily wage — for each day of recovery. Using the same $100 daily wage over a 60-day recovery and treatment period:</p>
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li>per diem pain &amp; suffering = $100 × 60 days = <strong style={{ color: '#FBBF24' }}>$6,000</strong></li>
              <li>total (per diem) = $6,400 + $6,000 = <strong style={{ color: '#FBBF24' }}>$12,400</strong></li>
              <li>fault-adjusted = $12,400 × (100 − 0) / 100 = <strong style={{ color: '#FBBF24' }}>$12,400</strong></li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>Run Your Own Numbers</h2>
            ...
            <h3 className="heading-gradient" style={h3Style}>Is a minor car accident with no injury still worth filing a claim for?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Does whiplash always qualify as a &ldquo;real&rdquo; injury for settlement purposes?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>What&rsquo;s the difference between a no-fault state and an at-fault state?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Can I take a minor car accident claim to small claims court?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>How long do I have to file a claim after a minor accident?</h3>
            ...
            <h2 className="heading-gradient" style={h2Style}>Not Legal Advice</h2>
