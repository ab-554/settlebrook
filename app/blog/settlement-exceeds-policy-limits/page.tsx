      ...
      <main className="min-h-screen" style={{ backgroundColor: '#050A18' }}>
        ...
        <article className="max-w-7xl mx-auto px-6 sm:px-8 py-12">
          <div className="max-w-3xl">
            ...
            <h2 className="heading-gradient" style={h2Style}>What &ldquo;policy limits&rdquo; actually means</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li>The first number is the most the policy pays for <strong style={{ color: '#E2E8F0' }}>one person&rsquo;s</strong> bodily injury, in thousands.</li>
              <li>The second is the most it pays for <strong style={{ color: '#E2E8F0' }}>all injuries combined</strong> in one accident.</li>
              <li>The third is the most it pays for <strong style={{ color: '#E2E8F0' }}>property damage</strong>.</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>A worked example: how the gap shows up</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              ...
              <li><strong style={{ color: '#E2E8F0' }}>Multiplier base</strong> (medical + future medical + wages + future wages): $65,000</li>
              <li>Property damage: $9,000</li>
              <li><strong style={{ color: '#E2E8F0' }}>Special damages</strong> (multiplier base + property damage): $65,000 + $9,000 = <strong style={{ color: '#FBBF24' }}>$74,000</strong></li>
              <li>Injury severity: &ldquo;serious&rdquo; → multiplier of 3.5</li>
              <li><strong style={{ color: '#E2E8F0' }}>Pain and suffering</strong>: $65,000 × 3.5 = <strong style={{ color: '#FBBF24' }}>$227,500</strong></li>
              <li><strong style={{ color: '#E2E8F0' }}>Total damages</strong>: $74,000 + $227,500 = <strong style={{ color: '#FBBF24' }}>$301,500</strong></li>
              <li>Claimant is found 10% at fault, so the fault-adjusted estimate is $301,500 × (100 − 10) / 100 = $301,500 × 0.90 = <strong style={{ color: '#FBBF24' }}>$271,350</strong></li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>Where the rest of the money can come from</h2>

            <h3 className="heading-gradient" style={h3Style}>Your own underinsured motorist (UIM) coverage</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Other liable parties</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>The at-fault driver&rsquo;s personal assets</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Umbrella policies</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Med-pay and PIP</h3>
            ...
            <h2 className="heading-gradient" style={h2Style}>The insurer&rsquo;s duty to settle, and &ldquo;bad faith&rdquo;</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>What to do if your claim looks like it&rsquo;s headed this way</h2>
            ...
            <h3 className="heading-gradient" style={h3Style}>Does it matter if my damages exceed the policy limit — can I still get more than that from the at-fault driver directly?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>What happens if damages exceed insurance limits and I don&rsquo;t have UM/UIM coverage?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>What is an underinsured motorist (UIM) claim, in plain terms?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Can the insurance company be held responsible for refusing a fair settlement within the policy limit?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Is it worth pursuing the at-fault driver&rsquo;s personal assets if their insurance limit isn&rsquo;t enough?</h3>
            ...
            <p style={{ ...bodyStyle, fontSize: '14px' }}><strong style={{ color: '#E2E8F0' }}>This article is for general information only and is not legal advice.</strong> Insurance and injury law vary by state and by the specific facts of a claim. For advice about your situation, talk to a licensed attorney in your state.</p>
