      ...
      <main className="min-h-screen" style={{ backgroundColor: '#050A18' }}>
        ...
        <article className="max-w-7xl mx-auto px-6 sm:px-8 py-12">
          <div className="max-w-3xl">
            ...
            <h2 className="heading-gradient" style={h2Style}>What an Injury Claim Calculator Actually Does</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li><strong style={{ color: '#E2E8F0' }}>The multiplier method</strong> takes your economic damages and multiplies them by a factor tied to how serious the injury is.</li>
              <li><strong style={{ color: '#E2E8F0' }}>The per diem method</strong> assigns a dollar value to each day you were affected by the injury and multiplies it by the number of recovery days.</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>The Building Blocks of a Claim Value</h2>

            <h3 className="heading-gradient" style={h3Style}>Special Damages (the economic side)</h3>
            ...
            <p style={bodyStyle}>In Settlebrook&rsquo;s calculator, we add the first four of these together into what we call the <strong style={{ color: '#E2E8F0' }}>multiplier base</strong> (medical bills + future medical + lost wages + future lost wages), and we add property damage on top of that separately to get <strong style={{ color: '#E2E8F0' }}>special damages</strong>.</p>

            <h3 className="heading-gradient" style={h3Style}>General Damages (pain and suffering)</h3>
              ...
              <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid rgba(99,179,237,0.15)' }}>
                    <th className="text-left py-2 pr-4" style={{ color: '#E2E8F0' }}>Severity</th>
                    <th className="text-left py-2" style={{ color: '#E2E8F0' }}>Multiplier</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={sev} style={{ borderBottom: '1px solid rgba(99,179,237,0.08)' }}>
                      <td className="py-2 pr-4" style={{ color: '#94A3B8' }}>{sev}</td>
                      <td className="py-2" style={{ color: '#94A3B8' }}>{mult}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <h3 className="heading-gradient" style={h3Style}>The Per Diem Alternative</h3>
            ...
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Per diem pain and suffering = daily rate × recovery days</strong></p>
            ...
            <h2 className="heading-gradient" style={h2Style}>Worked Example: How the Math Comes Together</h2>
            ...
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>The facts (all hypothetical):</strong></p>
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
            ...
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Step 1 — Multiplier base</strong><br />$18,000 + $7,000 + $6,000 + $4,000 = <strong style={{ color: '#FBBF24' }}>$35,000</strong></p>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Step 2 — Special damages</strong><br />$35,000 (multiplier base) + $5,000 (property damage) = <strong style={{ color: '#FBBF24' }}>$40,000</strong></p>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Step 3 — Pain and suffering</strong><br />$35,000 × 2.5 = <strong style={{ color: '#FBBF24' }}>$87,500</strong></p>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Step 4 — Total (pre-fault-adjustment)</strong><br />$40,000 + $87,500 = <strong style={{ color: '#FBBF24' }}>$127,500</strong></p>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>Step 5 — Fault-adjusted total</strong><br />$127,500 × (100 − 20) / 100 = $127,500 × 0.80 = <strong style={{ color: '#FBBF24' }}>$102,000</strong></p>
            <p style={bodyStyle}>So in this hypothetical, a claim worth $127,500 before any fault dispute lands at <strong style={{ color: '#FBBF24' }}>$102,000</strong> once a 20% comparative-fault finding is applied.</p>
            <p style={bodyStyle}><strong style={{ color: '#E2E8F0' }}>For comparison, the per diem alternative:</strong><br />If we instead valued pain and suffering at a daily rate of $150 over 240 recovery days:<br />$150 × 240 = <strong style={{ color: '#FBBF24' }}>$36,000</strong> (versus $87,500 under the multiplier method)</p>
            ...
            <h2 className="heading-gradient" style={h2Style}>What an Insurance Adjuster Actually Weighs</h2>
            ...
            <ul style={{ ...bodyStyle, paddingLeft: 24, listStyleType: 'disc' }}>
              <li><strong style={{ color: '#E2E8F0' }}>Documentation quality.</strong> Consistent, itemized medical records and bills that clearly tie treatment to the incident carry more weight than gaps or vague notes.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Treatment gaps.</strong> A large gap between the incident and your first medical visit, or long pauses in treatment, gives an adjuster a reason to argue the injury wasn&rsquo;t serious or wasn&rsquo;t caused by the incident.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Policy limits.</strong> An insurer will not pay more than the at-fault party&rsquo;s available coverage, regardless of how strong the claim is, which is why policy limits are one of the first things an adjuster checks.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Liability disputes.</strong> If fault is contested, the adjuster is pricing in the cost and risk of litigation, not just the injury itself.</li>
              <li><strong style={{ color: '#E2E8F0' }}>Venue.</strong> The jurisdiction where a case would be tried affects an adjuster&rsquo;s internal valuation, since local jury tendencies and court procedures vary.</li>
            </ul>
            ...
            <h2 className="heading-gradient" style={h2Style}>How Comparative Fault Changes the Number</h2>
            ...
            <h3 className="heading-gradient" style={h3Style}>Pure Comparative Fault — New York</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Modified Comparative Fault, 50% Bar — Georgia</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Modified Comparative Fault, 51% Bar — Florida</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Contributory Negligence — Maryland</h3>
            ...
            <h2 className="heading-gradient" style={h2Style}>Car Accidents Add Extra Layers</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>Using the Calculator the Right Way</h2>
            ...
            <h2 className="heading-gradient" style={h2Style}>Frequently Asked Questions</h2>

            <h3 className="heading-gradient" style={h3Style}>Is an injury claim calculator the same as what an insurance company uses?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>What multiplier should I use for my injury?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Does comparative fault apply even if the other driver was mostly at fault?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Why did the insurance company&rsquo;s number come out lower than my calculator estimate?</h3>
            ...
            <h3 className="heading-gradient" style={h3Style}>Should I accept the insurance company&rsquo;s first offer?</h3>
