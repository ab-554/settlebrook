      ...
      <main className="min-h-screen">
        ...
        <article className="container-page py-10 sm:py-12">
          <div className="editorial">
            ...
            <h2 className="heading-serif h2-editorial">What an Injury Claim Calculator Actually Does</h2>
            ...
            <h2 className="heading-serif h2-editorial">The Building Blocks of a Claim Value</h2>

            <h3 className="heading-serif h3-editorial">Special Damages (the economic side)</h3>
            ...
            <h3 className="heading-serif h3-editorial">General Damages (pain and suffering)</h3>
            ...
            <h3 className="heading-serif h3-editorial">The Per Diem Alternative</h3>
            ...
            <h2 className="heading-serif h2-editorial">Worked Example: How the Math Comes Together</h2>
            ...
            <h2 className="heading-serif h2-editorial">What an Insurance Adjuster Actually Weighs</h2>
            ...
            <h2 className="heading-serif h2-editorial">How Comparative Fault Changes the Number</h2>
            ...
            <h3 className="heading-serif h3-editorial">Pure Comparative Fault — New York</h3>
            ...
            <h3 className="heading-serif h3-editorial">Modified Comparative Fault, 50% Bar — Georgia</h3>
            ...
            <h3 className="heading-serif h3-editorial">Modified Comparative Fault, 51% Bar — Florida</h3>
            ...
            <h3 className="heading-serif h3-editorial">Contributory Negligence — Maryland</h3>
            ...
            <h2 className="heading-serif h2-editorial">Car Accidents Add Extra Layers</h2>
            ...
            <h2 className="heading-serif h2-editorial">Using the Calculator the Right Way</h2>
            ...
            <h3 className="heading-serif h3-editorial">Is an injury claim calculator the same as what an insurance company uses?</h3>
            ...
            <h3 className="heading-serif h3-editorial">What multiplier should I use for my injury?</h3>
            ...
            <h3 className="heading-serif h3-editorial">Does comparative fault apply even if the other driver was mostly at fault?</h3>
            ...
            <h3 className="heading-serif h3-editorial">Why did the insurance company&rsquo;s number come out lower than my calculator estimate?</h3>
            ...
            <h3 className="heading-serif h3-editorial">Should I accept the insurance company&rsquo;s first offer?</h3>
