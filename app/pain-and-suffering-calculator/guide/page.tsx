      ...
      <main className="min-h-screen">
        ...
        <div className="container-page py-8 sm:py-12">
          ...
          <article className="editorial">
            ...
            <p style={{ color: 'var(--ink-2)', lineHeight: 1.8, marginBottom: 20 }}>There is no single universal formula. Courts, insurance companies, and attorneys use two primary methods: the multiplier method and the per diem method. Both are legitimate, both are used regularly, and knowing how each one works gives you a concrete basis for evaluating any settlement offer you receive.</p>
            ...
            <p style={{ color: 'var(--ink-2)', lineHeight: 1.8, marginBottom: 20 }}>Some attorneys present both calculations in a demand letter and use whichever produces a stronger, more defensible number. That is a legitimate strategy. Our <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> runs both methods so you can see which one produces a stronger estimate for your specific situation.</p>
            
            <hr style={{ borderColor: "var(--line)", margin: "40px 0" }} />
            
            <h2 className="heading-display h2-editorial">Which Method Produces a Higher Number</h2>
            <p style={{ color: 'var(--ink-2)', lineHeight: 1.8, marginBottom: 20 }}>The answer depends on the specifics of your case, which is why attorneys run both.</p>
            ...
            <p style={{ color: 'var(--ink-2)', lineHeight: 1.8, marginBottom: 20 }}>Permanency of impairment — an official impairment rating from a treating or independent physician — adds a measurable, documented dimension to pain and suffering that is difficult for an adjuster to dismiss. Treatment with credentialed specialists (orthopedic surgeons, neurologists, physiatrists) rather than chiropractors alone increases credibility and Colossus scores.</p>
