  ...
  return (
    <>
      ...
      <main className="min-h-screen" style={{ backgroundColor: '#050A18' }}>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-8 py-7 sm:py-12">
            <BreadcrumbNav items={[
              { label: 'Home', href: '/' },
            ...
            <div className="mt-6 text-center max-w-4xl mx-auto">
              <h1 className="heading-gradient font-bold leading-tight" style={{ fontSize: 'clamp(32px, 5vw, 56px)', letterSpacing: '-0.02em' }}>
                How Is Pain and Suffering Calculated? Complete Guide
              </h1>
              <p className="mt-4 text-base sm:text-xl leading-relaxed max-w-3xl mx-auto" style={{ color: '#94A3B8' }}>
