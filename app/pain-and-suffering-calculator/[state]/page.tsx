    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <HeroBand
          ...
          title={<>Pain &amp; Suffering Calculator — {stateData.name}</>}
          promise={<>
        ...
        >
          {stateData.isNoFaultState && (
            <div className="mt-5"><span className="state-badge state-badge-blue">No-Fault Auto State</span></div>
          )}
        </HeroBand>
        ...
        <div className="container-page pb-14 sm:pb-20">
          ...
          {stateData.slug === 'california' ? (
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under California Law</h2>
              ...
              <h2 className="heading-display h2-editorial">California&apos;s Pure Comparative Fault Rule</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect California Pain and Suffering Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">California Statute of Limitations</h2>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use the <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> above to estimate your damages, then read through this page to understand exactly how Texas law affects your number.</p>

              <hr style={{ borderColor: 'var(--line)', margin: '36px 0' }} />

              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Texas Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Texas Pain and Suffering Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Texas Statute of Limitations</h2>
              ...
              <WorkedExample
                ...
                calculatorHref="/pain-and-suffering-calculator/"
              />
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>If you are comparing jurisdictions, see our <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link> — California&apos;s pure comparative fault rule and jury tendencies produce a different result on identical facts.</p>
              ...
              <h2 className="heading-display h2-editorial">Use the Calculator — Then Talk to an Attorney</h2>
            ...
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">Florida No-Fault Insurance and the Pain and Suffering Threshold</h2>
              ...
              <h2 className="heading-display h2-editorial">Florida&apos;s 2023 Tort Reform — What Changed</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Florida Pain and Suffering Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Florida Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Use the Calculator — Then Talk to a Florida Attorney</h2>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>The <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> gives you a baseline estimate using the multiplier and per diem methods. It is a starting point, not a settlement offer. Florida&apos;s no-fault threshold, the 2023 comparative fault changes, and the new two-year limitation period make legal guidance more important here than in almost any other state.</p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>If your injuries are permanent and your accident occurred recently, the two-year clock is already running. Most Florida personal injury attorneys work on contingency — no fee unless you recover. For comparison, the <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link> and <Link href="/pain-and-suffering-calculator/texas/" style={{ color: 'var(--primary)' }}>Texas pain and suffering calculator</Link> pages walk through how those states handle the same calculation under their own rules.</p>
            </article>
            ...
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">New York No-Fault Insurance and the Serious Injury Threshold</h2>
              ...
              <h2 className="heading-display h2-editorial">New York Pure Comparative Fault</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Compare how other states handle this using our <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link> and <Link href="/pain-and-suffering-calculator/texas/" style={{ color: 'var(--primary)' }}>Texas pain and suffering calculator</Link>.</p>

              <hr style={{ borderColor: 'var(--line)', margin: '36px 0' }} />

              <h2 className="heading-display h2-editorial">Factors That Affect New York Pain and Suffering Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">New York Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Why New York Settlements Trend High</h2>
              ...
              <WorkedExample
                ...
                calculatorHref="/pain-and-suffering-calculator/"
              />
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>The <Link href="/pain-and-suffering-calculator/florida/" style={{ color: 'var(--primary)' }}>Florida pain and suffering calculator</Link> page shows the contrast — Florida&apos;s $10,000 PIP floor and two-year statute produce structurally different claim dynamics.</p>
            ...
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Pennsylvania Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Pennsylvania Choice No-Fault — Limited Tort vs Full Tort</h2>
              ...
              <h3 className="heading-display" style={{ fontSize: '22px', fontWeight: 600 }}>Full Tort</h3>
              ...
              <h3 className="heading-display" style={{ fontSize: '22px', fontWeight: 600 }}>Limited Tort</h3>
              ...
              <h3 className="heading-display" style={{ fontSize: '22px', fontWeight: 600 }}>Exceptions to Limited Tort</h3>
              ...
              <h3 className="heading-display" style={{ fontSize: '22px', fontWeight: 600 }}>Why This Matters for Your Calculation</h3>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to run both methods with your own numbers. For a deeper explanation of how the math works, read <Link href="/pain-and-suffering-calculator/guide/" style={{ color: 'var(--primary)' }}>how pain and suffering is calculated</Link>.</p>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Pennsylvania Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Pennsylvania Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Use the Pennsylvania Pain and Suffering Calculator</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to estimate both the multiplier method and per diem method with your actual medical expenses and income. If you are also researching how other states handle non-economic damages, compare with the <Link href="/pain-and-suffering-calculator/new-york/" style={{ color: 'var(--primary)' }}>New York pain and suffering calculator</Link>. The calculator is free, takes under two minutes, and gives you a baseline to evaluate whatever the insurer puts on the table.</p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>For a deeper look at how these formulas are applied, read <Link href="/pain-and-suffering-calculator/guide/" style={{ color: 'var(--primary)' }}>how pain and suffering is calculated</Link>.</p>

              <hr style={{ borderColor: 'var(--line)', margin: '36px 0' }} />

              <h2 className="heading-display h2-editorial">Illinois Modified Comparative Fault — The 51% Rule</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Illinois Pain and Suffering Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Illinois Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Why Illinois Settlements Can Run High</h2>
              ...
              <h2 className="heading-display h2-editorial">Use the Illinois Pain and Suffering Calculator</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use the <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to enter your medical expenses, lost wages, and injury details. The calculator applies both the multiplier and per diem methods and gives you an Illinois-specific estimate in under two minutes.</p>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>If you want to understand how the numbers are built, read our guide on <Link href="/pain-and-suffering-calculator/guide/" style={{ color: 'var(--primary)' }}>how pain and suffering is calculated</Link>. If you were injured in another state, see the <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link> for a comparison of how capped states handle the same calculation differently.</p>
            </article>
          ) : stateData.slug === 'ohio' ? (
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Ohio Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Ohio Noneconomic Damage Cap — How the Formula Works</h2>
              ...
              <h3 className="heading-display" style={{ fontSize: '22px', fontWeight: 600 }}>The Catastrophic Injury Exception</h3>
              ...
              <h2 className="heading-display h2-editorial">Ohio Modified Comparative Fault</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Ohio Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Ohio Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Estimate Your Ohio Pain and Suffering Settlement</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to run the multiplier and per diem methods against your actual damages figures. If you want to understand the full framework before you calculate, read our detailed guide on <Link href="/pain-and-suffering-calculator/guide/" style={{ color: 'var(--primary)' }}>how pain and suffering is calculated</Link>. For a comparison of how a neighboring state handles these damages, see the <Link href="/pain-and-suffering-calculator/illinois/" style={{ color: 'var(--primary)' }}>Illinois pain and suffering calculator</Link>.</p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to estimate your non-economic damages using both the multiplier method and per diem method. This guide explains exactly how pain and suffering is calculated in Georgia, what Georgia&apos;s 50% bar means for your claim, and the deadlines you cannot afford to miss.</p>

              <hr style={{ borderColor: 'var(--line)', margin: '36px 0' }} />

              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Georgia Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Georgia Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Government Entity Claims in Georgia</h2>
              ...
              <h2 className="heading-display h2-editorial">Georgia Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Use the Georgia Pain and Suffering Calculator</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to estimate your non-economic damages under both the multiplier and per diem methods. If your accident happened in a neighboring state, our <Link href="/pain-and-suffering-calculator/florida/" style={{ color: 'var(--primary)' }}>Florida pain and suffering calculator</Link> applies Florida&apos;s comparative fault rules to your claim.</p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>North Carolina follows pure contributory negligence, a fault rule so strict that if an insurer can show you were even 1% responsible for your own injury, you recover nothing. Not a reduced amount — nothing. Use this page alongside our <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to build a realistic picture of what your claim may be worth, and read our complete guide on <Link href="/pain-and-suffering-calculator/guide/" style={{ color: 'var(--primary)' }}>how pain and suffering is calculated</Link> before you negotiate.</p>

              <hr style={{ borderColor: 'var(--line)', margin: '36px 0' }} />

              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under North Carolina Law</h2>
              ...
              <h2 className="heading-display h2-editorial">North Carolina Damage Caps</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect North Carolina Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">North Carolina Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">How Contributory Negligence Shapes Outcomes</h2>
              ...
              <WorkedExample
                ...
                calculatorHref="/pain-and-suffering-calculator/"
              />
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Compare your state with our <Link href="/pain-and-suffering-calculator/georgia/" style={{ color: 'var(--primary)' }}>Georgia pain and suffering calculator</Link> to understand how different fault rules change outcomes.</p>
              ...
              <h2 className="heading-display h2-editorial">Calculate Your North Carolina Pain and Suffering Estimate</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> now to enter your medical expenses, lost wages, and injury severity. The calculator applies both the multiplier and per diem methods and gives you an instant estimate you can use as a baseline in any settlement discussion.</p>
            ...
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">Michigan No-Fault Insurance and the Serious Impairment Threshold</h2>
              ...
              <h2 className="heading-display h2-editorial">Michigan Modified Comparative Fault</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Michigan Settlements</h2>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use the <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> above to estimate your non-economic damages using both the multiplier method and the per diem method. The sections below explain how Washington law shapes those numbers.</p>

              <hr style={{ borderColor: 'var(--line)', margin: '36px 0' }} />

              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Washington Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Washington Pure Comparative Fault</h2>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Washington follows the pure comparative fault doctrine under <Link href="https://app.leg.wa.gov/RCW/default.aspx?cite=4.22.005" style={{ color: 'var(--primary)' }}>RCW 4.22.005</Link>. Pure comparative fault means your recovery is reduced by your percentage of fault — but never eliminated by it. Even if you were 90 percent at fault for your own injury, you can still recover 10 percent of your total damages from the other responsible party.</p>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>To understand <Link href="/pain-and-suffering-calculator/guide/" style={{ color: 'var(--primary)' }}>how pain and suffering is calculated</Link> alongside fault reductions, see our full methodology guide.</p>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Washington Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Washington Statute of Limitations</h2>
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Washington imposes a three-year statute of limitations on personal injury claims under <Link href="https://app.leg.wa.gov/RCW/default.aspx?cite=4.16.080" style={{ color: 'var(--primary)' }}>RCW 4.16.080</Link>. The clock starts running on the date of your injury. If you do not file a lawsuit within three years, your claim is permanently barred and no court will hear it — regardless of how severe your injuries are or how clear the other party&apos;s liability may be.</p>
              ...
              <h2 className="heading-display h2-editorial">Use the Washington Pain and Suffering Calculator</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use the free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to estimate your non-economic damages using both the multiplier and per diem methods. If you are comparing results across states, see how Washington compares to the <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link>.</p>
            ...
            <article className="editorial">
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to run your numbers. Then read on to understand the Colorado-specific rules that will shape your result, including the modified comparative fault 50% bar, the bifurcated statute of limitations, and what the Colorado Supreme Court&apos;s 2025 ruling in <em>Banner Health v. Gresser</em> means for catastrophic injury victims.</p>
              ...
              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Colorado Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Colorado Modified Comparative Fault — The 50% Bar</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Colorado Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Colorado Statute of Limitations</h2>
              ...
              <h2 className="heading-display h2-editorial">Estimate Your Colorado Pain and Suffering Damages Now</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use the free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to enter your medical expenses, lost wages, and injury details and get an instant estimate using both the multiplier and per diem methods. If you are comparing state rules, see how Colorado&apos;s framework stacks up against the <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link>.</p>
            ...
            <article className="editorial">
              ...
              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Nevada Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Nevada Damage Caps — Med Mal vs. General PI</h2>
              ...
              <h2 className="heading-display h2-editorial">Nevada Modified Comparative Fault</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Nevada Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Nevada Statute of Limitations</h2>
              ...
              <WorkedExample
                ...
                calculatorHref="/pain-and-suffering-calculator/"
              />
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>For context on how Nevada compares to neighboring states, see our <Link href="/pain-and-suffering-calculator/california/" style={{ color: 'var(--primary)' }}>California pain and suffering calculator</Link>.</p>
              ...
              <h2 className="heading-display h2-editorial">Use the Nevada Pain and Suffering Calculator</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use our free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> now to run both the multiplier and per diem methods against your actual medical expenses and lost wages. The estimate is free, takes under two minutes, and gives you a defensible starting point for your Nevada personal injury claim.</p>
            </article>
          ) : stateData.slug === 'arizona' ? (
            <article className="editorial">
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>If you were injured in Arizona due to someone else&apos;s negligence, you may be entitled to pain and suffering damages on top of your medical bills and lost wages. Arizona is one of the most plaintiff-friendly states in the country — it has no cap on noneconomic damages and applies pure comparative fault, meaning you can recover compensation even if you were partially at fault. Use our free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to estimate your claim, then read on to understand exactly how Arizona law shapes your settlement.</p>
              ...
              <h2 className="heading-display h2-editorial">Pain and Suffering Damages Under Arizona Law</h2>
              ...
              <h2 className="heading-display h2-editorial">Arizona Pure Comparative Fault</h2>
              ...
              <h2 className="heading-display h2-editorial">Factors That Affect Arizona Settlements</h2>
              ...
              <h2 className="heading-display h2-editorial">Arizona Statute of Limitations</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Do not wait to get an estimate of your claim. Use the <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> now and consult an attorney well before the deadline approaches.</p>
              ...
              <h2 className="heading-display h2-editorial">Estimate Your Arizona Pain and Suffering Damages</h2>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.8', marginBottom: '18px' }}>Use the free <Link href="/pain-and-suffering-calculator/" style={{ color: 'var(--primary)' }}>Pain and Suffering Calculator</Link> to run your numbers using both the multiplier method and the per diem method. Enter your medical expenses, select your injury severity, and get an immediate estimate of your noneconomic damages under Arizona law. The calculator is free, takes under two minutes, and gives you the objective baseline you need before any conversation with an adjuster or attorney.</p>
            </article>
          ) : (
            ...
            <>
              ...
              <article className="mt-14 max-w-3xl" aria-label={`Pain and suffering damages guide for ${stateData.name}`}>
                <h2 className="heading-display mb-5" style={{ fontSize: 30, fontWeight: 700 }}>
              ...
              <section className="mt-10 max-w-3xl" aria-label={`${stateData.name} pain and suffering FAQs`}>
                <h2 className="heading-display mb-6" style={{ fontSize: 26, fontWeight: 700 }}>
